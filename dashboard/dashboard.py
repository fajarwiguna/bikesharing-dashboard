...
### 1️⃣ Pola Peminjaman Sepeda Berdasarkan Bulan & Musim ###
...
### 2️⃣ Pengaruh Cuaca terhadap Peminjaman ###
st.header("🌦️ Pengaruh Kondisi Cuaca terhadap Peminjaman")

# Visualisasi hubungan suhu dengan peminjaman
fig, ax = plt.subplots(figsize=(12, 6))
...
### 3️⃣ Perbandingan Pengguna Kasual vs Terdaftar ###
st.header("👤 Perbandingan Pengguna Kasual & Terdaftar")

# Agregasi jumlah peminjaman berdasarkan tipe pengguna
...
### 4️⃣ Pola Penggunaan Sepeda oleh Pengguna Kasual ###
